...
// create rectangle 3
$svg_rect_3 = SVGUtils::rect($dom_doc_svg,'50','50','rect_3','220','120','5','5','red','black');
$svg_svg->appendChild($svg_rect_3);

// create circle 1
$svg_circle_1 = new SVGCircleElement($dom_doc_svg);
$svg_rect_1->setId('circle_1');
...
// create circle 3
$svg_circle_3 = SVGUtils::circle($dom_doc_svg,'10','circle_3','150','60','red','black','3');
