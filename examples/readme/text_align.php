...
// create rectangle
$svg_rect = SVGFElement::rect($dom_doc_svg,80,80,'rect',180,20,null,null,'#d9737a');

// create text
$svg_text_0 = SVGFElement::text($dom_doc_svg,'CENTERED','text_0',0,0,'Helvetica','10px','normal','#861a22');
$svg_text_1 = SVGFElement::text($dom_doc_svg,'On top and left aligned','text_1',0,0,'Helvetica','16px','normal','#861a22');
$svg_text_2 = SVGFElement::text($dom_doc_svg,'Aligned with bottom-right corner','text_2',0,0,'Helvetica','10px','normal','#861a22');
$svg_text_3 = SVGFElement::text($dom_doc_svg,'Below and to the right','text_3',0,0,'Helvetica','14px','normal','#861a22');
$svg_text_4 = SVGFElement::text($dom_doc_svg,'To the left','text_4',0,50,'Helvetica','24px','normal','#861a22');
