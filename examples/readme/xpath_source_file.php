...
// create circles
$svg_circle_1 = SVGUtils::circle($dom_doc_svg,10,'circle_1',25,25);
$svg_circle_2 = SVGUtils::circle($dom_doc_svg,15,'circle_2',75,25,'#861a22');
$svg_circle_3 = SVGUtils::circle($dom_doc_svg,20,'circle_3',125,25,'#d9737a','#861a22',2);

// create rectangles
$svg_rect_1 = SVGUtils::rect($dom_doc_svg,40,40,'rect_1',5,55,null,null,'#d9737a','#861a22',2);
$svg_rect_2 = SVGUtils::rect($dom_doc_svg,30,30,'rect_2',60,60,null,null,'#861a22');
$svg_rect_3 = SVGUtils::rect($dom_doc_svg,20,20,'rect_3',115,65);
