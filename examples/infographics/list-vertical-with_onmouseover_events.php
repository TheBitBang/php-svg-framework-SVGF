...
foreach ($array_data as $data)
{
	...
	foreach ($array_sides_items as $side_items)
	{
		...
		foreach($side_items as $row_key => $row_value)
		{
			...
			// set highlighting events
			$svg_element__row_item->setAttribute('onmouseover',"getElementById('row_item $data_id $row_key').style.opacity=0.5; getElementById('anchor $data_id $row_key').style.opacity=0.5; getElementById('connector $data_id $row_key').style.opacity=0.5; getElementById('connector_shadow $data_id $row_key').style.opacity=0.1;");
			$svg_element__row_text->setAttribute('onmouseover',"getElementById('row_item $data_id $row_key').style.opacity=0.5; getElementById('anchor $data_id $row_key').style.opacity=0.5; getElementById('connector $data_id $row_key').style.opacity=0.5; getElementById('connector_shadow $data_id $row_key').style.opacity=0.1");
			$svg_element__row_item->setAttribute('onmouseout',"getElementById('row_item $data_id $row_key').style.opacity=1; getElementById('anchor $data_id $row_key').style.opacity=1; getElementById('connector $data_id $row_key').style.opacity=1; getElementById('connector_shadow $data_id $row_key').style.opacity=0.3");
			$svg_element__row_text->setAttribute('onmouseout',"getElementById('row_item $data_id $row_key').style.opacity=1; getElementById('anchor $data_id $row_key').style.opacity=1; getElementById('connector $data_id $row_key').style.opacity=1; getElementById('connector_shadow $data_id $row_key').style.opacity=0.3");
